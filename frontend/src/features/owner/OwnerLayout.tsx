...
export function OwnerLayout(){
  ...
  return <div className="owner-layout">
    <aside className={`owner-sidebar ${open?'owner-sidebar--open':''}`}>
    ...
    <div className="owner-main">
      <header className="owner-topbar"><button type="button" className="owner-menu" onClick={()=>setOpen(true)} aria-label="Abrir navegação"><Menu size={20}/></button><span>Castro’s Services</span><div><small>Área executiva</small><strong>{session?.displayName||'CEO / Owner'}</strong></div></header>
