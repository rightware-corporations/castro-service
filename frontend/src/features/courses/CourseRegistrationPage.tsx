...
export function CourseRegistrationPage() {
  ...
  const valid = Boolean(draft.firstName.trim() && draft.email.includes('@') && draft.participantCount > 0)
