export const apiRoutes = {
  ...
  courseRegistration: (sessionId: string) => `/api/v1/course-sessions/${encodeURIComponent(sessionId)}/registrations`,
  ...
  operationsBookingSchedule: (id: string) => `/api/v1/operations/bookings/${encodeURIComponent(id)}/schedule`,
  operationsBookingScheduleSlots: (id: string) => `/api/v1/operations/bookings/${encodeURIComponent(id)}/schedule/slots`,
  ...
  operationsNotifications: '/api/v1/operations/notifications',
  ...
  operationsCourseRegistrations: '/api/v1/operations/course-registrations',
  operationsCourseRegistrationStatus: (id: string) => `/api/v1/operations/course-registrations/${encodeURIComponent(id)}/status`,
