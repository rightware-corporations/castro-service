...
function DialogSurface({ title, onClose, children, labelledBy }: { title: string; onClose: () => void; children: ReactNode; labelledBy?: string }) {
  ...
  return <m.div className="ds-overlay" role="presentation" initial={motionPresets.scrim.initial} animate={motionPresets.scrim.animate} exit={motionPresets.scrim.exit} transition={motionPresets.scrim.transition} onMouseDown={(event) => { if (isPresent && event.target === event.currentTarget) onClose() }}><m.section ref={dialogRef} inert={!isPresent} aria-hidden={isPresent ? undefined : true} tabIndex={-1} className="ds-dialog" role="dialog" aria-modal="true" aria-labelledby={titleId} initial={motionPresets.panel.initial} animate={motionPresets.panel.animate} exit={motionPresets.panel.exit} transition={motionPresets.panel.transition}><div className="ds-dialog__header"><h2 id={titleId}>{title}</h2><IconButton ref={closeButtonRef} label="Fechar" onClick={onClose}><X size={18} /></IconButton></div><div className="ds-dialog__body">{children}</div></m.section></m.div>
}
...
function DrawerSurface({ title, onClose, children }: { title: string; onClose: () => void; children: ReactNode }) {
  ...
  return <m.div className="ds-overlay ds-overlay--drawer" role="presentation" initial={motionPresets.scrim.initial} animate={motionPresets.scrim.animate} exit={motionPresets.scrim.exit} transition={motionPresets.scrim.transition} onMouseDown={(event) => { if (isPresent && event.target === event.currentTarget) onClose() }}><m.aside ref={drawerRef} inert={!isPresent} aria-hidden={isPresent ? undefined : true} tabIndex={-1} className="ds-drawer" role="dialog" aria-modal="true" aria-labelledby={titleId} initial={motionPresets.drawer.initial} animate={motionPresets.drawer.animate} exit={motionPresets.drawer.exit} transition={motionPresets.drawer.transition}><div className="ds-dialog__header"><h2 id={titleId}>{title}</h2><IconButton ref={closeButtonRef} label="Fechar" onClick={onClose}><X size={18} /></IconButton></div><div className="ds-dialog__body">{children}</div></m.aside></m.div>
}
...
function BottomSheetSurface({ title, onClose, children }: { title: string; onClose: () => void; children: ReactNode }) {
  ...
  return <m.div className="ds-overlay ds-motion-overlay--sheet" role="presentation" initial={motionPresets.scrim.initial} animate={motionPresets.scrim.animate} exit={motionPresets.scrim.exit} transition={motionPresets.scrim.transition}><m.div ref={sheetRef} inert={!isPresent} aria-hidden={isPresent ? undefined : true} tabIndex={-1} className="ds-bottom-sheet ds-bottom-sheet--open" role="dialog" aria-modal="true" aria-labelledby={titleId} initial={motionPresets.bottomSheet.initial} animate={motionPresets.bottomSheet.animate} exit={motionPresets.bottomSheet.exit} transition={motionPresets.bottomSheet.transition}><div className="ds-bottom-sheet__handle" aria-hidden="true" /><div className="ds-dialog__header"><h2 id={titleId}>{title}</h2><IconButton ref={closeButtonRef} label="Fechar" onClick={onClose}><X size={18} /></IconButton></div><div className="ds-dialog__body">{children}</div></m.div></m.div>
}
