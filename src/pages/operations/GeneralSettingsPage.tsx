...
export function GeneralSettingsPage() {
  ...
  return <GeneralSettingsForm key={`${settings.data.organizationName}:${settings.data.businessTimezone}`} initial={settings.data} />
}
...
function GeneralSettingsForm({ initial }: { initial: GeneralSettingsDto }) {
  ...
  return <section className="catalog-admin">
    ...
    <section className="catalog-admin__summary">
      ...
      <article><small>Slug</small><strong>{initial.organizationSlug}</strong></article>
