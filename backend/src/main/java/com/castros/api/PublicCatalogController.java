...
public class PublicCatalogController {
    ...
    @GetMapping("/courses/{id}/sessions") public List<Object> sessions(@PathVariable UUID id){return sessions.findByCourseIdAndActiveTrueOrderByStartAtAsc(id).stream().map(s->Map.of("id",s.id,"startAt",s.startAt,"endAt",s.endAt)).collect(Collectors.toList());}
